...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'allCategories',
        loadChildren: () => import('./pages/categories/categories.module').then(m => m.CategoriesModule),canActivate: [AuthGuard]
  ...
  {
    path: 'pos',
    component: MainPosComponent,canActivate: [AuthGuard]
  },
